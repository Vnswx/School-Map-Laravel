...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('forcss/css/ds.css') }}">
...
<body>
    ...
    <div class="container">
        <hr>
        <img class="A1" src="{{ asset('forcss/img/1.jpeg') }}" alt="">

        <img class="A2" src="{{ asset('forcss/img/4.jpeg') }}" alt="">
        
        <img class="A3" src="{{ asset('forcss/img/3.jpeg') }}" alt="">
        
        <div class="center">
        </div>
        <div class="kotak">
            <!-- <h2>Welcome Dahboard admin 3D SMK Taruna Bhakti</h2> -->
        </div>
</body>
</html>